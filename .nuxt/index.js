...
async function createApp(ssrContext, config = {}) {
  ...
  if (typeof nuxt_plugin_plugin_83873042 === 'function') {
  ...
  if (process.server && typeof nuxt_plugin_pluginserver_2b2632b2 === 'function') {
    await nuxt_plugin_pluginserver_2b2632b2(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_pluginclient_f69915c2 === 'function') {
    await nuxt_plugin_pluginclient_f69915c2(app.context, inject)
  }
