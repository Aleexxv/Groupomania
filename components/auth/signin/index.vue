<template>
	<div class="content">
		...
		<img src="~assets/img/bg-home-2.jpg" class="bg-home" alt="">
			...
			<h1 class="hello">Bienvenue {{signText}} sur votre espace détente ! </h1>
			<form class="form">
				<input type="text" placeholder="Nom">
				<input type="text" placeholder="Prénom">
				<input type="text" placeholder="Email">
				<input type="password" placeholder="Password">
				<NuxtLink to="/signin"><input type="submit" class="button"></NuxtLink>
			</form>
			<button v-on:click="changeModeLeft" class="changeMode-left">Connectez-vous !</button>
			<colorModePicker class="CMPsign" />
		</div>
	</div>
</template>
